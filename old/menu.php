 <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      <div class="container">
        <a href="/me" class="navbar-brand" style="color: #ffbf01; font-weight: 700">JIC</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/me/projects.php">Projects</a>
            </li>
            <li class="nav-item">
              <a id="source-button"  class="nav-link" href="#" onclick="showcontact()">Contact</a>
            </li>          
          </ul>
