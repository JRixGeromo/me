...
<body data-spy="scroll" data-target=".navbar-nav">
    ...
    <section id="about" class="section-padding about-area bg-light">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-bg" style="background-image:url(assets/images/about-bg.png)">
                        <!-- Social Link -->
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <h2>Hello, I am <span>Jose Rico Geromo</span></h2>
                        <!-- <h4>Graphic Designer and Web Designer</h4> -->
                        <p>I'm a home based full stack web developer living in the Philippines with 20+ years of experience. I make fully responsive/mobile friendly web application using various programming languages depending on client's preference such as laravel, codeigniter, mysql, vue.js, javascript, jquery, nextgen(former mirthconnect), typo3, wordpress, expession engine, etc...<br><br>Implemented 3rd party application integration with Stripe, Cronofy, Zoho Subscription, Zapier, Google Calendar, etc.
                        </p>
                        ...
                        <div id="skills" class="skill-area">
                            ...
                            <div class="single-skill">
                                <div class="skillbar" data-percent="90%">
                                    <div class="skillbar-title"><span>VUEJS</span></div>
                                    <div class="skillbar-bar"></div>
                                    <div class="skill-bar-percent">90%</div>
                                </div>
                            </div>
    ...
    <section class="section-padding pb-70 bg-img fact-counter" id="counter" style="background-image: url(assets/images/fan-fact-bg.jpg)">
        <div class="container">
            <div class="row">
                <!-- Single Fact Counter -->
                <div class="col-lg-4 co col-md-4 l-md-6 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="25">0</span>+</h2>
                ...
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="single-fun-fact">
                        <h2><span class="counter-value" data-count="3041">0</span>+</h2>
                        <p>Cups of Coffee</p>
                    </div>
                </div>
                <!-- // Single Fact Counter -->
    ...
    <!-- ====== Service Section ====== -->
    <section id="service" class="section-padding pb-70 service-area bg-light" style="display: none">
        <div class="container">
            <!-- Section Title -->
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
    ...
    <section id="" class="section-padding why-choose-us pb-70" style="display: none">
        <div class="container">
            <!-- Section Title -->
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
                ...
                <div class="col-lg-8">
                    <div class="work-list text-center">
                        <ul>
                            ...
                            <li class="filter" data-filter=".web">Projects</li>
                            <li class="filter" data-filter=".template">Templates</li>
    ...
    <!-- ====== Blog Section ====== -->
    <section class="section-padding pb-70 blog-section bg-light" style="display: none">
        <div class="container">
            <!-- Section Title -->
            <div class="row justify-content-center">
                <div class="col-lg-6 ">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/1.png)">
                        ...
                        <div class="team-content">
                            <h4>Jose Rico Geromo</h4>
                            <span>Founder / Senior Web Developer</span>
                        </div>
                    </div>
                </div>
                <!-- // Single Team -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/2.png)">
                            <div class="team-social">
                                <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-team">
                        <div class="team-thumb" style="background-image: url(assets/images/team/3.png)">
                            <div class="team-social">
                                <a target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-twitter"></i></a>
                                <a target="_blank" href="#"><i class="fab fa-linkedin"></i></a>
    ...
    <!-- ====== Call to Action Area ====== -->
    <section class="section-padding call-to-action-aria bg-secondary" style="display: none">
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="copyright-text">
                        <p class="text-white">© 2017 jintelcare.com</a></p>
                    </div>
                </div>
            </div>
        </div>
